(function(){
  ...
  style.textContent=`
    .screen-limit-wrap{display:flex;flex-direction:column;gap:8px;margin-top:8px}
  ...
  wrap.innerHTML=`
    ...
    <div class="screen-limit-warning" id="screenLimitWarning">Choose 1, 2 or 3 colours before adding artwork.</div>
  `;
  ...
  function ready(){return maxColours>0&&selected.length===maxColours;}
